...
input_text = "I am Vijetha, Working in Tata Consultancy Services at Bengaluru location. And working for Ortho Clinical project."

def translate_text(text, target_language):
    result = translate_client.translate(text, target_language=target_language)
    return result['translatedText']

# Translate text to Italian (language code 'it')
output = translate_text(input_text, 'it')
